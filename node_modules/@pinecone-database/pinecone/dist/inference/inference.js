...
var Inference = /** @class */ (function () {
    ...
    Inference.prototype._formatParams = function (parameters) {
        return parameters;
    };
    ...
    Inference.prototype.embed = function (model, inputs, params) {
        return __awaiter(this, void 0, void 0, function () {
            var typedAndFormattedInputs, typedParams, typedRequest, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        typedAndFormattedInputs = this._formatInputs(inputs);
                        typedParams = this._formatParams(params);
                        typedRequest = {
                            embedRequest: {
                                model: model,

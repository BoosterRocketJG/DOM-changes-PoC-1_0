...
jest.mock('../../pinecone-generated-ts-fetch/data', function () { return (__assign(__assign({}, jest.requireActual('../../pinecone-generated-ts-fetch/data')), { Configuration: jest.fn() })); });
    ...
    test('passing additionalHeaders applies them to the API Configuration', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    expect(data_1.Configuration).toHaveBeenCalledWith(expect.objectContaining({

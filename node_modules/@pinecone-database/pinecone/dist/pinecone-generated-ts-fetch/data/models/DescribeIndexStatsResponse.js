...
function DescribeIndexStatsResponseFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        namespaces: !(0, runtime_1.exists)(json, 'namespaces')
            ? undefined
            : (0, runtime_1.mapValues)(json['namespaces'], NamespaceSummary_1.NamespaceSummaryFromJSON),
        dimension: !(0, runtime_1.exists)(json, 'dimension') ? undefined : json['dimension'],
        indexFullness: !(0, runtime_1.exists)(json, 'indexFullness')
            ? undefined
            : json['indexFullness'],
        totalVectorCount: !(0, runtime_1.exists)(json, 'totalVectorCount')
            ? undefined
...
function DescribeIndexStatsResponseToJSON(value) {
    ...
    return {
        namespaces: value.namespaces === undefined
            ? undefined
            : (0, runtime_1.mapValues)(value.namespaces, NamespaceSummary_1.NamespaceSummaryToJSON),

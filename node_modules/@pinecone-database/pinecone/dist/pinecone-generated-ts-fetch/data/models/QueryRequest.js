...
function QueryRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        includeValues: !(0, runtime_1.exists)(json, 'includeValues')
            ? undefined
            : json['includeValues'],
        includeMetadata: !(0, runtime_1.exists)(json, 'includeMetadata')
            ? undefined
            : json['includeMetadata'],
        queries: !(0, runtime_1.exists)(json, 'queries')
            ? undefined
            : json['queries'].map(QueryVector_1.QueryVectorFromJSON),
        vector: !(0, runtime_1.exists)(json, 'vector') ? undefined : json['vector'],
        sparseVector: !(0, runtime_1.exists)(json, 'sparseVector')
            ? undefined
            : (0, SparseValues_1.SparseValuesFromJSON)(json['sparseVector']),
...
function QueryRequestToJSON(value) {
    ...
    return {
        ...
        queries: value.queries === undefined
            ? undefined
            : value.queries.map(QueryVector_1.QueryVectorToJSON),
        vector: value.vector,

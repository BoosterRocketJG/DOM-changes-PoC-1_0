...
function FetchResponseFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        vectors: !(0, runtime_1.exists)(json, 'vectors')
            ? undefined
            : (0, runtime_1.mapValues)(json['vectors'], Vector_1.VectorFromJSON),
...
function FetchResponseToJSON(value) {
    ...
    return {
        vectors: value.vectors === undefined
            ? undefined
            : (0, runtime_1.mapValues)(value.vectors, Vector_1.VectorToJSON),

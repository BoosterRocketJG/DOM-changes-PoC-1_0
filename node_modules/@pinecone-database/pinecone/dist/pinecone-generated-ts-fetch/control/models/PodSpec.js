...
function PodSpecFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        pods: json['pods'],
        metadataConfig: !(0, runtime_1.exists)(json, 'metadata_config')
            ? undefined
            : (0, PodSpecMetadataConfig_1.PodSpecMetadataConfigFromJSON)(json['metadata_config']),
        sourceCollection: !(0, runtime_1.exists)(json, 'source_collection')
            ? undefined

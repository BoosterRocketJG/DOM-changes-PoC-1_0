...
function CollectionListFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        collections: !(0, runtime_1.exists)(json, 'collections')
            ? undefined
            : json['collections'].map(CollectionModel_1.CollectionModelFromJSON),
    };
}
...
function CollectionListToJSON(value) {
    ...
    return {
        collections: value.collections === undefined
            ? undefined
            : value.collections.map(CollectionModel_1.CollectionModelToJSON),
    };
}

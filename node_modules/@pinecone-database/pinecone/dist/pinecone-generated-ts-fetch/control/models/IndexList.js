...
function IndexListFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        indexes: !(0, runtime_1.exists)(json, 'indexes')
            ? undefined
            : json['indexes'].map(IndexModel_1.IndexModelFromJSON),
    };
}
...
function IndexListToJSON(value) {
    ...
    return {
        indexes: value.indexes === undefined
            ? undefined
            : value.indexes.map(IndexModel_1.IndexModelToJSON),
    };
}
